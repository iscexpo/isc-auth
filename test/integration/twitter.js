...
const {
  ISCAUTH_TWITTER_USERNAME: USERNAME,
  ISCAUTH_TWITTER_PASSWORD: PASSWORD,
} = process.env
...
describe('Twitter (OAuth 1.1 flow)', async function () {
  ...
  it('should be returned to callback URL', async function () {
    ...
    await page.waitForSelector('#iscauth-test-page')
  ...
  it('should be signed in', async function () {
    ...
    await page.waitForSelector('#iscauth-signed-in')
    return Promise.resolve()
  })
