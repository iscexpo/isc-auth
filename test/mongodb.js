...
const Adapters = require('../adapters')
  ...
  ; (async () => {
    try {
      ...
      Adapters.Default('mongodb+srv://iscauth:password@127.0.0.1/iscauth?ssl=false&retryWrites=true')
      ...
      const adapter = Adapters.Default('mongodb://iscauth:password@127.0.0.1:27017/iscauth?synchronize=true')
